...
public class SearchController {
    ...
    public void searchIndex(@RequestParam String term){
        List<String> cities = Arrays.asList("Ankara", "İstanbul", "Mersin", "Adana","Zonguldak", "Malatya", "Elazığ", "Hakkari" , "İzmir", "Tekirdağ", "Trabzon");
        ...
        while(true){
            ...
            long offset = Timestamp.valueOf("2022-04-07 01:00:00").getTime();
            long end = Timestamp.valueOf("2022-04-07 20:00:00").getTime();
    ...
    public void searchIndexStream(@RequestParam String term){
        ...
        messageProducer.sendStream(jsonObject.toJSONString());
